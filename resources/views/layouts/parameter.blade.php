        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item active">
                <a class="nav-link" href="{{url('/parameter')}}">Parameter <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
            <ul class="nav nav-pills flex-column" id="siderbar">
                <li class="nav-item"><strong>Organization</strong></li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/department')}}" id="department">Department</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/position')}}" id="position">Position</a>
                </li>
                <li class="nav-item"><strong>Loan</strong></li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/payment-mood')}}" id="payment_mood">Payment Mood</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/provision')}}" id="provision">Provision</a>
                </li>
                <li class="nav-item"><strong>Place / Location</strong></li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/country')}}" id="country">Country</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/province')}}" id="province">Province</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link" href="{{url('/district')}}" id="district">District</a>
                </li>
                 <li class="nav-item">
