        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{url('/commune/update')}}" class="form-horizontal" method="post" onsubmit="return confirm('You want to save?')">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="province_id" id="province_id" class="form-control">
                                        @foreach($provinces as $pro)
                                            <option value="{{$pro->id}}" {{$commune->province_id==$pro->id?'selected':''}}>{{$pro->name}}</option>
                                        @endforeach
                                       </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       ...
                                       @foreach($districts as $d)
                                            <option value="{{$d->id}}" {{$d->id==$commune->district_id?'selected':''}}>{{$d->name}}</option>
                                       @endforeach
                                       </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$commune->code}}" name="code" id="code" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{$commune->name}}" id="name" name="name" required>
